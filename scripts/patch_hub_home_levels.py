...
old_explore = 'if (el.homeExplore) el.homeExplore.onclick=()=>goToExplorer(null);'
new_explore = 'if (el.homeExplore) el.homeExplore.addEventListener("click",()=>goToExplorer(null));'
